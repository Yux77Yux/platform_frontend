...
export default function Page() {
    ...
    const { count, creationInfoGroup } = creations
    ...
    const fetchCreationInfo = useCallback(async (userId, type, page) => {
    ...
    useEffect(() => {
        ...
        fetchCreationInfo(userId, type, page)

    }, [userId, spaceCreations, fetchCreationInfo])
