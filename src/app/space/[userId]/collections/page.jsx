...
export default function Page() {
    ...
    const fetchCollections = useCallback(async (userId, type, page) => {
        const response = await fetch(`http://localhost:8080/api/creation/collections/${userId}/${page}/${type}`, {
            method: "GET",
            headers: {
    ...
    useEffect(() => {
        const { type, page } = spaceCreations
        console.log(type)

        // fetchCollections(userId, type, page)

    }, [userId, spaceCreations, fetchCollections])
