...
import './page.scss'
import { Status, updateReview, getNewUserReviews, getUserReviews } from "@/src/tool/review"
...
const Page = () => {
    ...
    const getNewReviews = useCallback(async () => {
        ...
        const result = await getNewUserReviews(token)
    ...
    useEffect(() => {
        ...
        (async () => {
            const token = await getToken();
            const result = await getUserReviews(status, page, token);
            if (!result) return;
    ...
    return <>
        ...
        <div className='review-user'>
            ...
            <div className="content" style={{ boxShadow: 'none', borderBottom: '1px solid rgb(111,111,111)' }}>
                ...
                <div className="content-avatar">头像</div>
...
const Content = ({ reviewInfo, removeReview, setTextPrompt, isPending }) => {
    ...
    return <>
        <div className="content">
            ...
            <div className="content-avatar" style={{ minHeight: '100px' }}>
                <div style={{
                    position: 'relative',
                    height: '80px',
                    width: '80px',
                    ...
                    <Image src={userAvatar} alt='' fill quality={100} objectFit='cover' />
                </div>
            </div>
